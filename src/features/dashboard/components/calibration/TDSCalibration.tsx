    ...
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 max-w-md mx-auto leading-relaxed">
          ...
          dan algoritma polynomial cubic.
        </p>
      </div>
              ...
              <div>
                <div className="text-sm font-mono bg-green-50 p-3 rounded border">
                  <span className="text-green-700">
                    Koef = {calculateCompensationCoeff(currentTemp).toFixed(4)}
                  </span>
                </div>
                <div className="text-xs text-gray-600 mt-1">
              ...
              <div>
                <div className="text-sm font-mono bg-yellow-50 p-3 rounded border">
                  <span className="text-yellow-700">
                    V_comp = {(currentVoltage / calculateCompensationCoeff(currentTemp)).toFixed(4)} V
                  </span>
                </div>
                <div className="text-xs text-gray-600 mt-1">
                  {currentVoltage.toFixed(4)} ÷ {calculateCompensationCoeff(currentTemp).toFixed(4)}
                </div>
              </div>
            </div>
          </div>
